...
# AI 通道分辨率(chn2 XGA 1024x768,过热修复 2026-08-11 恢复官方 main2 同构:
# K230 ISP chn2 不支持 VGA 小尺寸,配 VGA 致 snapshot(chn=2) 挂死;XGA 是
# chn2 RGBP888 板端验证组合,det 320/reg 112 输入用 XGA 源充足)
